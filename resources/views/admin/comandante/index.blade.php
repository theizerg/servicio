    ...
    @section('content')
        ...
        <div class="card card-danger card-outline">
                ...
                <table id="inactivos" class="table table-striped table-bordered">
                    ...
                    <td>
                      <a class="btn btn-round yellow darken-4" href="{{  url('comandante', [$inactivo->id,'imprimir']) }}"><i class="material-icons" style="color: white;">print</i> Perfil</a>
                       <a class="btn btn-round blue darken-4" href="{{  url('comandante', [$inactivo->id]) }}"><i class="material-icons" style="color: white;">person</i> Perfil</a>
                       <a class="btn btn-round red darken-4" href="{{ url('comandante', [$inactivo->id, 'edit']) }}"><i class="material-icons" style="color: white;">edit</i> Editar</a>
                    </td>
                    </tr>
                    @endforeach
                    </tr>
